      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 hidden lg:flex flex-col gap-8">
            <Leaderboard edits={edits} onSelect={handleSelectFromLeaderboard} className="min-h-[360px]" />

            {/* Info Box */}
            <div className="flex-1 bg-slate-900/80 border border-slate-800 rounded-3xl p-8 shadow-xl relative overflow-hidden group min-h-[360px]">
